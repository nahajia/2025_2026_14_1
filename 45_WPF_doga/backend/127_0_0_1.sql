...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2026. Már 10. 17:05
...
--
-- Adatbázis: `szinkronhangok`
--
CREATE DATABASE IF NOT EXISTS `szinkronhangok` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `szinkronhangok`;
...
CREATE TABLE `film` (
  ...
  `eredeti` varchar(70) DEFAULT NULL,
  `ev` int(4) NOT NULL,
  `rendezo` varchar(40) DEFAULT NULL,
  `magyarszoveg` varchar(40) DEFAULT NULL,
  `szinkronrendezo` varchar(40) DEFAULT NULL,
...
CREATE TABLE `szinkron` (
  ...
  `szerep` varchar(50) DEFAULT NULL,
  `szinesz` varchar(50) DEFAULT NULL,
...
--
-- AUTO_INCREMENT a táblához `szinkron`
--
ALTER TABLE `szinkron`
  MODIFY `szinkid` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1761;
