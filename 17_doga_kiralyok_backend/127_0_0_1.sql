...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2025. Okt 13. 18:21
...
-- Adatbázis: `kiralyok`
--
CREATE DATABASE IF NOT EXISTS `kiralyok2025` DEFAULT CHARACTER SET utf8 COLLATE utf8_hungarian_ci;
USE `kiralyok2025`;

-- --------------------------------------------------------

--
-- Tábla szerkezet ehhez a táblához `hivatal`
--
...
--
-- A tábla adatainak kiíratása `hivatal`
--
...
--
-- Tábla szerkezet ehhez a táblához `uralkodo`
--

CREATE TABLE `uralkodo` (
  `azon` int(11) NOT NULL,
  `nev` varchar(30) NOT NULL,
  `ragnev` varchar(30) DEFAULT NULL,
...
--
-- A tábla adatainak kiíratása `uralkodo`
--
...
--
-- Tábla szerkezet ehhez a táblához `uralkodohaz`
--
...
--
-- A tábla adatainak kiíratása `uralkodohaz`
--
...
--
-- AUTO_INCREMENT a táblához `hivatal`
--
ALTER TABLE `hivatal`
  MODIFY `azon` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;

--
-- AUTO_INCREMENT a táblához `uralkodo`
--
ALTER TABLE `uralkodo`
  MODIFY `azon` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;

--
-- AUTO_INCREMENT a táblához `uralkodohaz`
--
ALTER TABLE `uralkodohaz`
  MODIFY `azon` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
