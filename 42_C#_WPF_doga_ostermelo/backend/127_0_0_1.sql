...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2026. Már 08. 18:44
...
-- Adatbázis: `ostermelo`
--
CREATE DATABASE IF NOT EXISTS `ostermelo2026` DEFAULT CHARACTER SET utf8 COLLATE utf8_hungarian_ci;
USE `ostermelo2026`;
...
CREATE TABLE `gyumolcslevek` (
  `gyumolcslevek_ID` int(11) NOT NULL,
...
INSERT INTO `gyumolcslevek` (`gyumolcslevek_ID`, `gynev`) VALUES
(1, 'almalé'),
(2, 'körtelé'),
(3, 'szilvalé'),
(4, 'áfonyalé'),
...
ALTER TABLE `gyumolcslevek`
  ADD PRIMARY KEY (`gyumolcslevek_ID`);
...
--
ALTER TABLE `kiszallitasok`
  MODIFY `sorsz` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1025;
...
--
ALTER TABLE `kiszallitasok`
  ADD CONSTRAINT `fk_gyumleszall` FOREIGN KEY (`gyumleid`) REFERENCES `gyumolcslevek` (`gyumolcslevek_ID`),
